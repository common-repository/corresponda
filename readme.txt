...
Tags: dynamic content, widget, shortcode, dropdown, search, display links, display text, selection box, marketing
...
You can add both selectable text and corresponding text one by one, using the Corresponda user interface, or upload a CSV file. CSV files should consist of two columns with selectable text items in the first column and corresponding display text in the second column. 

How many widgets can I create?
You can create as many widgets as you like. Widgets must be created one by one via the plugin interface.
...
== Screenshots ==
1. Create widget interface
2. Edit widget interface
3. A dropdown box and autocomplete search box on an example page
